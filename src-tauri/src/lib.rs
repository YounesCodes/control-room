...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_pinned_commands,
            commands::create_pinned_command,
            commands::update_pinned_command,
            commands::reorder_pinned_commands,
            commands::delete_pinned_command,
