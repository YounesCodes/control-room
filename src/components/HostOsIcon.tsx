...
// Logo paths: Simple Icons 16.12.0 (CC0-1.0). Trademarks belong to their owners.

export type HostOsKind = "debian" | "ubuntu" | "unknown";

export function hostOsKind(osId: string | null | undefined): HostOsKind {
  switch (osId?.trim().toLowerCase()) {
    case "debian":
      return "debian";
    case "ubuntu":
      return "ubuntu";
