...
A **Saved Connection** is the reusable target for remote Workspaces and structured inspections. It is stored locally and contains an SSH destination and username, with optional connection overrides.
