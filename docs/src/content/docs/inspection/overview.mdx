...
Overview is not a health check. Zero failed services do not make a host healthy, and one capability read cannot prove that every service or container is working.
